...
class EditProject extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            geospatial_data: this.props.project.geospatial_data,
            data_sharing: this.props.project.data_sharing,
    ...
    componentDidMount() {
        ...
        axios.get('/api/user')
            .then(function (response) {
                ...
                let map = {};
                let users = [];
                if (thisProps.project.users) {
                    for (var j = 0; j < thisProps.project.users.length; j++) {
                        users.push(thisProps.project.users[j].id);
                    }
                }
    ...
    updateProject = () => {
        ...
        this.props.update_project(project);
    }
